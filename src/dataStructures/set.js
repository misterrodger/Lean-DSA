...
console.log(intersection(collection, collection2));  // [ 'item2' ]
console.log(difference(collection, collection2));  // [ 'item1', 'item3', 'item4' ]
console.log(subset(collection2, collection));  // false
